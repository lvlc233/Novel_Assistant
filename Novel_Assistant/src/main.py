...
from common.config.log.graph_log_handler import LLMLogHandler, NodeLogHandler
from core.agent.kd_build_graph import KDBuildGraph


# # 加载.env文件
# load_dotenv(dotenv_path="G:\\work\\project\\bishe\\Agent\\Novel_Assistant\\src\\config\\.env", override=True, encoding="utf-8")
...
if __name__ == "__main__":
    messages=[]
    kd_build_graph=KDBuildGraph()
    chat_graph=kd_build_graph.build()
    chat_graph.invoke(
        {
            "documents":{
                "1":document
