...
const EditNovelModal: React.FC<EditNovelModalProps> = ({ novel, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="w-[500px] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="h-14 border-b border-gray-100 flex items-center justify-between px-6 bg-gray-50">
          <span className="font-serif text-lg text-gray-800">编辑小说</span>
        ...
        <div className="p-8 flex gap-8">
          ...
          <div className="flex-1 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
               <label className="text-xs font-medium text-gray-500 uppercase tracking-wider">小说名</label>
               <input 
                 type="text" 
