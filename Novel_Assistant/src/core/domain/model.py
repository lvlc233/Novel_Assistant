...
class FolderEntity(BaseModel):
    ...
    table_of_contents: List[TableOfContentsItem] = Field(description="目录项列表")
...
class NovelDetailDomain(BaseModel):
    ...
    hiatus_interval: str = Field(description="断更间隔时间")
    table_of_contents: List[Union[FolderEntity, TableOfContentsItem]] = Field(description="小说目录")
