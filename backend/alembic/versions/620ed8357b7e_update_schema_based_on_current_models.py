"""update_schema_based_on_current_models

Revision ID: 620ed8357b7e
Revises: 
Create Date: 2026-01-30 13:49:36.482161
...
def upgrade() -> None:
    ...
    sa.Column('description', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('enabled', sa.Boolean(), nullable=False),
    sa.Column('type', sa.Enum('LONG_TERM', 'SHORT_TERM', name='memorytypeenum'), nullable=False),
    ...
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('description', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('from_type', sa.Enum('SYSTEM', 'CUSTOM', name='pluginfromtypeenum'), nullable=False),
    sa.Column('scope_type', sa.Enum('GLOBAL', 'WORK', 'DOCUMENT', name='pluginscopetypeenum'), nullable=False),
    sa.Column('enabled', sa.Boolean(), nullable=False),
    ...
    sa.Column('work_type', sa.Enum('NOVEL', name='worktypeenum'), nullable=False),
    sa.Column('state', sa.Enum('UPDATING', 'COMPLETED', 'HIATUS', name='workstateenum'), nullable=False),
    sa.Column('create_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.Column('update_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('enabled', sa.Boolean(), nullable=False),
    sa.Column('tags', sa.JSON(), nullable=True),
    sa.Column('relationship', sa.JSON(), nullable=True),
    sa.Column('configurable', sa.Boolean(), nullable=False),
    sa.Column('create_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.Column('update_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_work_type_name'), 'work_type', ['name'], unique=True)
    op.create_table('knowledge_chunk',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('kb_id', sa.Uuid(), nullable=False),
    sa.Column('content', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('search_keys', sa.JSON(), nullable=True),
    sa.Column('enabled', sa.Boolean(), nullable=False),
    sa.Column('create_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.Column('update_at', sa.TIMESTAMP(timezone=True), nullable=False),
    ...
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('description', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('node_type', sa.Enum('FOLDER', 'DOCUMENT', name='nodetypeenum'), nullable=False),
    sa.Column('create_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.Column('update_at', sa.TIMESTAMP(timezone=True), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_work_type_name'), table_name='work_type')
